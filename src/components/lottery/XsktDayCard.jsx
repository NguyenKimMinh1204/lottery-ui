  ...
  return (
    <div className="border border-gray-200 rounded-2xl shadow-sm p-6 mb-6 bg-gray-50 rounded-xl ">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
        ...
        {/* Right: 3 cols x 2 rows grid */}
        <div className="md:col-span-3">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
            {companies.map((c) => (
              <div
                key={c.id}
                className="group rounded-xl border border-indigo-100 p-4 text-center transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 bg-white/60"
              >
