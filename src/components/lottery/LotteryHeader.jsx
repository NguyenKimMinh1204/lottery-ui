...
// Header lựa chọn số: hiển thị ngày và thông tin tổng quan
// Props:
// - todayText: chuỗi ngày dd/mm/yyyy để hiển thị
    ...
    <div className="rounded-2xl border border-gray-200 bg-white/70 shadow-sm p-5 mb-6">
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
        ...
        <div className="md:col-span-2 flex flex-col md:items-end gap-2">
          {/* Badge số lượng/khả dụng tổng quan (có thể nối API thật sau) */}
          ...
          {/* Dòng mô tả giá trị giải đặc biệt trong ngày */}
